...
class KeyButton(QtWidgets.QPushButton):
    ...
    def __init__(self, key, parent=None):
        ...
        if key == "Backspace":
            ...
            self.setStyleSheet(
                "QPushButton {min-width: 100px;font-size: 20px; font-family: Noto Sans CJK JP;max-width: 200px; min-height:40px; max-height: 100px; border: 3px solid #8f8f91;border-radius: 8px;background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 #f6f7fa, stop: 1 #dadbde);}\nQPushButton:pressed {background-color: rgb(29, 150, 255);}")
            ...
            self.setStyleSheet(
                "QPushButton {min-width: 450px;font-size: 20px;font-family: Noto Sans CJK JP; max-width: 550px; min-height:40px; max-height: 100px; border: 3px solid #8f8f91;border-radius: 8px;background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 #f6f7fa, stop: 1 #dadbde);}\nQPushButton:pressed {background-color: rgb(29, 150, 255);}")
            ...
            self.setStyleSheet(
                "QPushButton {min-width: 80px;font-size: 20px;font-family: Noto Sans CJK JP; max-width: 80px; min-height:40px; max-height: 100px; border: 3px solid #8f8f91;border-radius: 8px;background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 #f6f7fa, stop: 1 #dadbde);}\nQPushButton:pressed {background-color: rgb(29, 150, 255);}")
...
class AlphaNeumericVirtualKeyboard(QtWidgets.QWidget):
    ...
    def __init__(self, source, x_pos=0, y_pos=0, parent=None):
       ...
       source : QLineEdit
        ...
        self.close_button = KeyButton("Clear", self)
    ...
    def convert_to_caps(self):
        ...
        for lineIndex, line in enumerate(keys):
            for keyIndex, key in enumerate(line):
                if key != ' ' and key != '  'and key != 'Backspace' and key != 'CAPS' and key != 'Clear' and key != 'Sym':
    ...
    def open_symbol(self):
        ...
        if not self.sym_state:
            ...
            self.sym_button.setStyleSheet("background-color:rgb(29, 150, 255);font-size: 20px;font-family: Noto Sans CJK JP;border: 3px solid #8f8f91;border-radius: 8px; min-height:42px; max-height: 100px; width: 120px;")
        elif self.caps_state:
            self.sym_state = 0
            keys = self.key_list_by_lines_caps
            self.sym_button.setStyleSheet("QPushButton {font-size: 20px;font-family: Noto Sans CJK JP;border: 3px solid #8f8f91;border-radius: 8px;background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 #f6f7fa, stop: 1 #dadbde);min-height:42px; max-height: 100px; width: 120px;}\nQPushButton:pressed {background-color: rgb(29, 150, 255);}")
        else:
            self.sym_state = 0
            keys = self.key_list_by_lines_lower
            self.sym_button.setStyleSheet("QPushButton {font-size: 20px;font-family: Noto Sans CJK JP;border: 3px solid #8f8f91;border-radius: 8px;background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 #f6f7fa, stop: 1 #dadbde);min-height:42px; max-height: 100px; width: 120px;}\nQPushButton:pressed {background-color: rgb(29, 150, 255);}")
    ...
    def display(self, source=None, event=None, ui_Scroll=None, closeButtonEnable=False, call_back=None, constraint=0, moveUp=False):
                ...
                for keyIndex, key in enumerate(line):
                    ...
                    if key == ' ':
                        ...
                        if self.caps_state == 1:
                            self.caps_button.setStyleSheet("background-color:rgb(29, 150, 255);border: 3px solid #8f8f91;border-radius: 8px; min-height:42px; max-height: 100px; width: 120px;")
                    elif key == 'Clear':
                        ...
                        if self.sym_state == 1:
                            self.sym_button.setStyleSheet("background-color:rgb(29, 150, 255);border: 3px solid #8f8f91;border-radius: 8px;min-height:42px; max-height: 100px; width: 120px;")
                    else:
                        button = KeyButton(key, self.parent)
                        self.array_buttons[lineIndex][keyIndex] = button
        ...
        self.setLayout(self.keys_layout)
