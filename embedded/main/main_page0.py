...
################################################################################
## Form generated from reading UI file 'main_page0.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_51.setMinimumSize(QSize(1920, 1080))
        ...
        self.display1.setMaximumSize(QSize(1920, 2160))
        ...
        self.menu_bar.setMaximumSize(QSize(400, 16777215))
        ...
        self.menuPage1.setGeometry(QRect(0, 0, 394, 70))
        ...
        self.menuPage2.setGeometry(QRect(0, 0, 394, 70))
        ...
        self.menuPage3.setGeometry(QRect(0, 0, 373, 85))
        ...
        self.main.setMinimumSize(QSize(600, 480))
        ...
        self.horizontalLayout_6.addWidget(self.priorityBox)
        ...
        self.horizontalLayout_3.addWidget(self.full_listBox)
        ...
        self.stackedCharts = QStackedWidget(self.frame_2)
        ...
        self.frame_220.setMaximumSize(QSize(100, 16777215))
        ...
        self.frame_230.setMaximumSize(QSize(100, 16777215))
        ...
        self.verticalLayout_2.addWidget(self.frame_222, 0, Qt.AlignBottom)
        ...
        self.verticalLayout_2.addWidget(self.label_Artist_3, 0, Qt.AlignVCenter)
        ...
        self.frame_219.setMinimumSize(QSize(100, 0))
        self.frame_219.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.verticalLayout_157.addWidget(self.verticalSlider_16, 0, Qt.AlignHCenter)

        self.pushButton_39 = QPushButton(self.frame_219)
        self.pushButton_39.setObjectName(u"pushButton_39")

        self.verticalLayout_157.addWidget(self.pushButton_39, 0, Qt.AlignHCenter)


        self.horizontalLayout_8.addWidget(self.frame_219, 0, Qt.AlignRight)
        ...
        self.frame_254.setMaximumSize(QSize(100, 16777215))
        ...
        self.frame_221.setMaximumSize(QSize(100, 16777215))
        ...
        self.frame_231.setMaximumSize(QSize(100, 16777215))
        ...
        self.verticalLayout_40.addWidget(self.stackedCharts)
        ...
        self.horizontalLayout_7.addWidget(self.frame_227)

        self.stackedMemoPages = QStackedWidget(self.frame_3)
        self.stackedMemoPages.setObjectName(u"stackedMemoPages")
        self.stackedMemoPages.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.stackedWidget = QStackedWidget(self.frame_123)
        self.stackedWidget.setObjectName(u"stackedWidget")
        self.page_6 = QWidget()
        self.page_6.setObjectName(u"page_6")
        self.horizontalLayout_36 = QHBoxLayout(self.page_6)
        self.horizontalLayout_36.setObjectName(u"horizontalLayout_36")
        self.gridLayout_10 = QGridLayout()
        self.gridLayout_10.setSpacing(10)
        self.gridLayout_10.setObjectName(u"gridLayout_10")
        self.gridLayout_10.setContentsMargins(0, 10, 0, 10)
        self.label_105 = QLabel(self.page_6)
...
"}")
        ...
        self.label_100 = QLabel(self.page_6)
...
"}")
        ...
        self.label_103 = QLabel(self.page_6)
...
"}")
        ...
        self.label_101 = QLabel(self.page_6)
...
"}")
        ...
        self.label_102 = QLabel(self.page_6)
...
"}")
        ...
        self.label_104 = QLabel(self.page_6)
...
"}")
        ...
        self.horizontalLayout_36.addLayout(self.gridLayout_10)

        self.stackedWidget.addWidget(self.page_6)
        self.page_7 = QWidget()
        self.page_7.setObjectName(u"page_7")
        self.horizontalLayout_37 = QHBoxLayout(self.page_7)
        self.horizontalLayout_37.setObjectName(u"horizontalLayout_37")
        self.gridLayout_12 = QGridLayout()
        self.gridLayout_12.setSpacing(10)
        self.gridLayout_12.setObjectName(u"gridLayout_12")
        self.gridLayout_12.setContentsMargins(0, 10, 0, 10)
        self.label_117 = QLabel(self.page_7)
...
"}")
        ...
        self.gridLayout_12.addWidget(self.label_117, 1, 1, 1, 1)

        self.label_118 = QLabel(self.page_7)
...
"}")
        ...
        self.gridLayout_12.addWidget(self.label_118, 0, 1, 1, 1)

        self.label_119 = QLabel(self.page_7)
...
"}")
        ...
        self.gridLayout_12.addWidget(self.label_119, 1, 0, 1, 1)

        self.label_120 = QLabel(self.page_7)
...
"}")
        ...
        self.gridLayout_12.addWidget(self.label_120, 0, 0, 1, 1)

        self.label_121 = QLabel(self.page_7)
...
"}")
        ...
        self.label_122 = QLabel(self.page_7)
...
"}")
        ...
        self.gridLayout_12.addWidget(self.label_122, 1, 2, 1, 1)


        self.horizontalLayout_37.addLayout(self.gridLayout_12)
        ...
        self.pushButton_59 = QPushButton(self.frame_120)
        self.pushButton_59.setObjectName(u"pushButton_59")
        self.pushButton_59.setMaximumSize(QSize(30, 16777215))

        self.horizontalLayout_44.addWidget(self.pushButton_59, 0, Qt.AlignBottom)
        ...
        self.stackedWidget_2 = QStackedWidget(self.frame_127)
        self.stackedWidget_2.setObjectName(u"stackedWidget_2")
        self.page_8 = QWidget()
        self.page_8.setObjectName(u"page_8")
        self.horizontalLayout_38 = QHBoxLayout(self.page_8)
        self.horizontalLayout_38.setObjectName(u"horizontalLayout_38")
        self.gridLayout_19 = QGridLayout()
        self.gridLayout_19.setSpacing(10)
        self.gridLayout_19.setObjectName(u"gridLayout_19")
        self.gridLayout_19.setContentsMargins(0, 10, 0, 10)
        self.label_106 = QLabel(self.page_8)
...
"}")
        ...
        self.label_107 = QLabel(self.page_8)
...
"}")
        ...
        self.label_108 = QLabel(self.page_8)
...
"}")
        ...
        self.label_109 = QLabel(self.page_8)
...
"}")
        ...
        self.label_110 = QLabel(self.page_8)
...
"}")
        ...
        self.label_182 = QLabel(self.page_8)
...
"}")
        ...
        self.horizontalLayout_38.addLayout(self.gridLayout_19)

        self.stackedWidget_2.addWidget(self.page_8)
        self.page_9 = QWidget()
        self.page_9.setObjectName(u"page_9")
        self.horizontalLayout_39 = QHBoxLayout(self.page_9)
        self.horizontalLayout_39.setObjectName(u"horizontalLayout_39")
        self.gridLayout_18 = QGridLayout()
        self.gridLayout_18.setSpacing(10)
        self.gridLayout_18.setObjectName(u"gridLayout_18")
        self.gridLayout_18.setContentsMargins(0, 10, 0, 10)
        self.label_123 = QLabel(self.page_9)
        self.label_123.setObjectName(u"label_123")
        self.label_123.setMaximumSize(QSize(120, 120))
        self.label_123.setStyleSheet(u"*{background: rgb(255, 243, 149)\n"
"}")
        self.label_123.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.label_123, 1, 1, 1, 1)

        self.label_124 = QLabel(self.page_9)
        self.label_124.setObjectName(u"label_124")
        self.label_124.setMaximumSize(QSize(120, 120))
        self.label_124.setStyleSheet(u"*{background: rgb(255, 243, 149)\n"
"}")
        self.label_124.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.label_124, 0, 1, 1, 1)

        self.label_125 = QLabel(self.page_9)
        self.label_125.setObjectName(u"label_125")
        self.label_125.setMaximumSize(QSize(120, 120))
        self.label_125.setStyleSheet(u"*{background: rgb(255, 243, 149)\n"
"}")
        self.label_125.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.label_125, 1, 0, 1, 1)

        self.label_126 = QLabel(self.page_9)
        self.label_126.setObjectName(u"label_126")
        self.label_126.setMaximumSize(QSize(120, 120))
        self.label_126.setStyleSheet(u"*{background: rgb(255, 243, 149)\n"
"}")
        self.label_126.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.label_126, 0, 0, 1, 1)

        self.label_127 = QLabel(self.page_9)
        self.label_127.setObjectName(u"label_127")
        self.label_127.setMaximumSize(QSize(120, 120))
        self.label_127.setStyleSheet(u"*{background: rgb(255, 243, 149)\n"
"}")
        self.label_127.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.label_127, 0, 2, 1, 1)

        self.label_128 = QLabel(self.page_9)
        self.label_128.setObjectName(u"label_128")
        self.label_128.setMaximumSize(QSize(120, 120))
        self.label_128.setStyleSheet(u"*{background: rgb(255, 243, 149)\n"
"}")
        self.label_128.setAlignment(Qt.AlignCenter)

        self.gridLayout_18.addWidget(self.label_128, 1, 2, 1, 1)


        self.horizontalLayout_39.addLayout(self.gridLayout_18)

        self.stackedWidget_2.addWidget(self.page_9)

        self.horizontalLayout_46.addWidget(self.stackedWidget_2)
        ...
        self.pushButton_58 = QPushButton(self.frame_129)
        self.pushButton_58.setObjectName(u"pushButton_58")
        self.pushButton_58.setMaximumSize(QSize(30, 16777215))

        self.horizontalLayout_74.addWidget(self.pushButton_58, 0, Qt.AlignBottom)
        ...
        self.stackedWidget_3 = QStackedWidget(self.frame_134)
...
"}")
        ...
        self.horizontalLayout_48.addWidget(self.stackedWidget_3)
        ...
        self.pushButton_61 = QPushButton(self.frame_136)
        self.pushButton_61.setObjectName(u"pushButton_61")
        self.pushButton_61.setMaximumSize(QSize(30, 16777215))

        self.horizontalLayout_49.addWidget(self.pushButton_61, 0, Qt.AlignBottom)
        ...
        self.pushButton_60 = QPushButton(self.frame_189)
        self.pushButton_60.setObjectName(u"pushButton_60")
        self.pushButton_60.setMaximumSize(QSize(30, 16777215))

        self.horizontalLayout_64.addWidget(self.pushButton_60, 0, Qt.AlignBottom)
        ...
        self.label_Title_4.setFont(font6)
...
"}")
        ...
        self.label_Title_6.setFont(font6)
        ...
        self.display2.setMaximumSize(QSize(1920, 2160))
        ...
        self.frame_57.setGeometry(QRect(0, 130, 1191, 141))
        self.frame_57.setFrameShape(QFrame.StyledPanel)
        self.frame_57.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_32 = QHBoxLayout(self.frame_57)
        self.horizontalLayout_32.setSpacing(30)
        self.horizontalLayout_32.setObjectName(u"horizontalLayout_32")
        self.horizontalLayout_32.setContentsMargins(0, 0, 0, 0)
        self.btn_painter_color1 = QPushButton(self.frame_57)
        self.btn_painter_color1.setObjectName(u"btn_painter_color1")
        self.btn_painter_color1.setMinimumSize(QSize(100, 100))
        self.btn_painter_color1.setStyleSheet(u"*{background:#000000;color:#FFFFFF;}")

        self.horizontalLayout_32.addWidget(self.btn_painter_color1)

        self.btn_painter_color2 = QPushButton(self.frame_57)
        self.btn_painter_color2.setObjectName(u"btn_painter_color2")
        self.btn_painter_color2.setMinimumSize(QSize(100, 100))
        self.btn_painter_color2.setStyleSheet(u"*{background:#F53333;color:#FFFFFF;}")

        self.horizontalLayout_32.addWidget(self.btn_painter_color2)

        self.btn_painter_color3 = QPushButton(self.frame_57)
        self.btn_painter_color3.setObjectName(u"btn_painter_color3")
        self.btn_painter_color3.setMinimumSize(QSize(100, 100))
        self.btn_painter_color3.setStyleSheet(u"*{background:#EE6A1F;color:#FFFFFF;}\n"
"")

        self.horizontalLayout_32.addWidget(self.btn_painter_color3)

        self.btn_painter_color4 = QPushButton(self.frame_57)
        self.btn_painter_color4.setObjectName(u"btn_painter_color4")
        self.btn_painter_color4.setMinimumSize(QSize(100, 100))
        self.btn_painter_color4.setStyleSheet(u"*{background:#E7EA5B;color:#FFFFFF;}")

        self.horizontalLayout_32.addWidget(self.btn_painter_color4)

        self.btn_painter_color5 = QPushButton(self.frame_57)
        self.btn_painter_color5.setObjectName(u"btn_painter_color5")
        self.btn_painter_color5.setMinimumSize(QSize(100, 100))
        self.btn_painter_color5.setStyleSheet(u"*{background:#1ACB16;color:#FFFFFF;}")

        self.horizontalLayout_32.addWidget(self.btn_painter_color5)

        self.btn_painter_color6 = QPushButton(self.frame_57)
        self.btn_painter_color6.setObjectName(u"btn_painter_color6")
        self.btn_painter_color6.setMinimumSize(QSize(100, 100))
        self.btn_painter_color6.setStyleSheet(u"*{background:#4C25E8;color:#FFFFFF;}")

        self.horizontalLayout_32.addWidget(self.btn_painter_color6)

        self.btn_painter_color7 = QPushButton(self.frame_57)
        self.btn_painter_color7.setObjectName(u"btn_painter_color7")
        self.btn_painter_color7.setMinimumSize(QSize(100, 100))
        self.btn_painter_color7.setStyleSheet(u"*{background:#B525E8;color:#FFFFFF;}")

        self.horizontalLayout_32.addWidget(self.btn_painter_color7)

        self.btn_painter_color8 = QPushButton(self.frame_57)
        self.btn_painter_color8.setObjectName(u"btn_painter_color8")
        self.btn_painter_color8.setMinimumSize(QSize(100, 100))
        self.btn_painter_color8.setStyleSheet(u"*{background:#E8258E;color:#FFFFFF;}")

        self.horizontalLayout_32.addWidget(self.btn_painter_color8)

        self.btn_painter_color9 = QPushButton(self.frame_57)
        self.btn_painter_color9.setObjectName(u"btn_painter_color9")
        self.btn_painter_color9.setMinimumSize(QSize(100, 100))
        self.btn_painter_color9.setStyleSheet(u"*{background:#ffffff;color:#000000;}")

        self.horizontalLayout_32.addWidget(self.btn_painter_color9)

        self.btn_painter_clear = QPushButton(self.frame_55)
        self.btn_painter_clear.setObjectName(u"btn_painter_clear")
        self.btn_painter_clear.setGeometry(QRect(1680, 149, 201, 101))
        font14 = QFont()
        font14.setPointSize(18)
        self.btn_painter_clear.setFont(font14)

        self.verticalLayout_32.addWidget(self.frame_55)

        self.painter_widget = QWidget(self.page_draw)
        self.painter_widget.setObjectName(u"painter_widget")
        self.painter_widget.setMinimumSize(QSize(0, 300))

        self.verticalLayout_32.addWidget(self.painter_widget)

        self.frame_56 = QFrame(self.page_draw)
        self.frame_56.setObjectName(u"frame_56")
        self.frame_56.setMinimumSize(QSize(0, 300))
        self.frame_56.setFrameShape(QFrame.StyledPanel)
        self.frame_56.setFrameShadow(QFrame.Raised)
        self.label_22 = QLabel(self.frame_56)
        self.label_22.setObjectName(u"label_22")
        self.label_22.setGeometry(QRect(0, 50, 860, 30))
        ...
        self.pushButton_53.setGeometry(QRect(1700, 30, 161, 150))
        sizePolicy.setHeightForWidth(self.pushButton_53.sizePolicy().hasHeightForWidth())
        self.pushButton_53.setSizePolicy(sizePolicy)
        self.pushButton_53.setMinimumSize(QSize(0, 150))
        self.pushButton_53.setMaximumSize(QSize(16777215, 100))
        self.pushButton_53.setFont(font14)
        ...
        self.pushButton_54.setFont(font16)
        ...
        self.label_27.setPixmap(QPixmap(u"../../../Users/snghs/PycharmProjects/audiro/venv/lp.png"))
        ...
        self.label_25.setPixmap(QPixmap(u"../../../Users/snghs/PycharmProjects/audiro/venv/qr.png"))
        ...
        self.pushButton_57.setFont(font16)
        ...
        self.label_30.setPixmap(QPixmap(u"../../../Users/snghs/PycharmProjects/audiro/venv/lp.png"))
        ...
        self.frame_63.setMinimumSize(QSize(0, 400))
        ...
        self.pushButton_55.setFont(font16)
        ...
        self.pushButton_56.setFont(font16)
        ...
        self.label_28.setPixmap(QPixmap(u"../../../Users/snghs/PycharmProjects/audiro/venv/lp.png"))
        ...
        self.verticalLayout_42.addWidget(self.frame_51)

        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1951, 26))
        ...
        self.rightButton_11.clicked.connect(MainWindow.nextMemos)
        ...
        self.btn_painter_color1.clicked.connect(MainWindow.colorChange1)
        self.btn_painter_color2.clicked.connect(MainWindow.colorChange2)
        self.btn_painter_color3.clicked.connect(MainWindow.colorChange3)
        self.btn_painter_color4.clicked.connect(MainWindow.colorChange4)
        self.btn_painter_color5.clicked.connect(MainWindow.colorChange5)
        self.btn_painter_color6.clicked.connect(MainWindow.colorChange6)
        self.btn_painter_color7.clicked.connect(MainWindow.colorChange7)
        self.btn_painter_color8.clicked.connect(MainWindow.colorChange8)
        self.btn_painter_color9.clicked.connect(MainWindow.colorChange9)
        self.btn_painter_clear.clicked.connect(MainWindow.painterClear)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_105.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_100.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_103.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_101.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_102.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_104.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_117.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.label_118.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.label_119.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.label_120.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.label_121.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.label_122.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.pushButton_59.setText(QCoreApplication.translate("MainWindow", u"\u25b6\ufe0f", None))
        ...
        self.label_106.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.label_107.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.label_108.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.label_109.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.label_110.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.label_182.setText(QCoreApplication.translate("MainWindow", u"page2", None))
        self.label_123.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_124.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_125.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_126.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_127.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_128.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.pushButton_58.setText(QCoreApplication.translate("MainWindow", u"\u25b6\ufe0f", None))
        ...
        self.label_111.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_112.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_113.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_114.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_115.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        self.label_116.setText(QCoreApplication.translate("MainWindow", u"page1", None))
        ...
        self.pushButton_61.setText(QCoreApplication.translate("MainWindow", u"\u25b6\ufe0f", None))
        ...
        self.pushButton_60.setText(QCoreApplication.translate("MainWindow", u"\u25b6\ufe0f", None))
        ...
        self.btn_painter_color1.setText(QCoreApplication.translate("MainWindow", u"Black", None))
        self.btn_painter_color2.setText(QCoreApplication.translate("MainWindow", u"Red", None))
        self.btn_painter_color3.setText(QCoreApplication.translate("MainWindow", u"Orange", None))
        self.btn_painter_color4.setText(QCoreApplication.translate("MainWindow", u"Yellow", None))
        self.btn_painter_color5.setText(QCoreApplication.translate("MainWindow", u"Green", None))
        self.btn_painter_color6.setText(QCoreApplication.translate("MainWindow", u"Blue", None))
        self.btn_painter_color7.setText(QCoreApplication.translate("MainWindow", u"Purple", None))
        self.btn_painter_color8.setText(QCoreApplication.translate("MainWindow", u"Pink", None))
        self.btn_painter_color9.setText(QCoreApplication.translate("MainWindow", u"White", None))
        self.btn_painter_clear.setText(QCoreApplication.translate("MainWindow", u"\uc804\uccb4 \uc9c0\uc6b0\uae30", None))
