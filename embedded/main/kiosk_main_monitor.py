...
"border-radius: 15px;")
        ...
        self.frame_118.setEnabled(False)
...
"border-radius: 15px;")
        ...
        self.frame_123.setEnabled(False)
        ...
        self.frame_124.setEnabled(False)
...
"border-radius: 25px;")
        ...
        self.frame_115.setEnabled(False)
        ...
        self.frame_126.setEnabled(False)
...
"}")
        ...
        self.verticalLayout_72.setSpacing(50)
        ...
        self.verticalLayout_72.addWidget(self.frame_179, 0, Qt.AlignTop)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 666, 514))
        ...
        self.verticalLayout_98.setSpacing(50)
        ...
        self.verticalLayout_98.addWidget(self.frame_171, 0, Qt.AlignTop)
        ...
        self.gift_reply_img.setWordWrap(True)

        self.horizontalLayout_80.addWidget(self.gift_reply_img, 0, Qt.AlignHCenter)
        ...
        self.horizontalLayout_138.addWidget(self.gift_reply_fulltime, 0, Qt.AlignRight)
        ...
        self.frame_156.setEnabled(False)
...
"}")
        ...
        self.postcard_detail_img.setMinimumSize(QSize(600, 500))
        font15 = QFont()
        ...
        self.postcard_detail_img.setScaledContents(True)
        self.postcard_detail_img.setAlignment(Qt.AlignCenter)
        self.postcard_detail_img.setWordWrap(True)

        self.horizontalLayout_9.addWidget(self.postcard_detail_img, 0, Qt.AlignHCenter|Qt.AlignVCenter)
        ...
        self.frame_165.setEnabled(False)
        ...
        self.frame_166.setEnabled(False)
...
"}")
        ...
        self.frame_35 = QFrame(self.page8)
        self.frame_35.setObjectName(u"frame_35")
        self.frame_35.setFrameShape(QFrame.StyledPanel)
        self.frame_35.setFrameShadow(QFrame.Raised)
        self.verticalLayout_104 = QVBoxLayout(self.frame_35)
...
";")
        ...
        self.verticalLayout_104.addWidget(self.pushButton_15, 0, Qt.AlignRight)

        self.frame_21 = QFrame(self.frame_35)
        ...
        self.qr2 = QLabel(self.frame_21)
        self.qr2.setObjectName(u"qr2")
        self.qr2.setMinimumSize(QSize(100, 100))
        self.qr2.setMaximumSize(QSize(200, 200))
        font16 = QFont()
        font16.setPointSize(20)
        self.qr2.setFont(font16)
        self.qr2.setPixmap(QPixmap(u"../resource/QR_img.png"))
        self.qr2.setScaledContents(True)
        self.qr2.setAlignment(Qt.AlignCenter)

        self.verticalLayout_17.addWidget(self.qr2, 0, Qt.AlignHCenter|Qt.AlignVCenter)
        ...
        self.verticalLayout_104.addWidget(self.frame_21, 0, Qt.AlignVCenter)


        self.verticalLayout_18.addWidget(self.frame_35, 0, Qt.AlignVCenter)
...
"}")
        ...
        self.verticalLayout_99.setSpacing(50)
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QRect(0, 0, 666, 514))
        ...
        self.verticalLayout_100.setSpacing(50)
...
" color:black; background-color: #2ae2e2;}")
        ...
        self.reply_song_img = QLabel(self.frame_36)
        self.reply_song_img.setObjectName(u"reply_song_img")
        self.reply_song_img.setMinimumSize(QSize(0, 500))
        self.reply_song_img.setFont(font15)
        self.reply_song_img.setStyleSheet(u"background:#D9D9D9; color:red;")
        self.reply_song_img.setTextFormat(Qt.AutoText)
        self.reply_song_img.setScaledContents(True)
        self.reply_song_img.setAlignment(Qt.AlignCenter)
        self.reply_song_img.setWordWrap(True)

        self.verticalLayout_48.addWidget(self.reply_song_img, 0, Qt.AlignTop)
        ...
        self.frame_138.setEnabled(False)
        ...
        self.frame_140.setEnabled(False)
...
"}")
        ...
        self.verticalLayout_48.addWidget(self.frame_31, 0, Qt.AlignBottom)
        ...
        self.verticalLayout_50.setSpacing(100)
...
" color:black; background-color: #2ae2e2;}")
        ...
        self.frame_33 = QFrame(self.frame_47)
        ...
        self.input_password = QLineEdit(self.frame_33)
        self.input_password.setObjectName(u"input_password")
        self.input_password.setMinimumSize(QSize(350, 50))
        self.input_password.setStyleSheet(u"*{color:black; background-color:#ffffff;}")

        self.horizontalLayout_26.addWidget(self.input_password)

        self.pushButton_20 = QPushButton(self.frame_33)
        self.pushButton_20.setObjectName(u"pushButton_20")
        self.pushButton_20.setMinimumSize(QSize(0, 50))
        font19 = QFont()
        font19.setPointSize(14)
        font19.setBold(True)
        self.pushButton_20.setFont(font19)
        self.pushButton_20.setStyleSheet(u"*{color:black;background-color: #d9d9d9;}")

        self.horizontalLayout_26.addWidget(self.pushButton_20)


        self.verticalLayout_103.addWidget(self.frame_33)
        ...
        self.input_phone_number = QLineEdit(self.frame_76)
        self.input_phone_number.setObjectName(u"input_phone_number")
        self.input_phone_number.setMinimumSize(QSize(420, 50))
        self.input_phone_number.setStyleSheet(u"*{color:black; background-color:#ffffff;}")

        self.horizontalLayout_30.addWidget(self.input_phone_number)
        ...
        self.verticalLayout_50.addWidget(self.frame_52, 0, Qt.AlignHCenter|Qt.AlignVCenter)


        self.verticalLayout_29.addWidget(self.frame_50, 0, Qt.AlignTop)
...
"  background-color: #2ae2e2;}")
        ...
        self.pushButton_37.setFont(font19)
...
"}")
        ...
        self.frame_34 = QFrame(self.frame_62)
...
";")
        ...
        self.horizontalLayout_27.addWidget(self.pushButton_24, 0, Qt.AlignRight)
        ...
        self.verticalLayout_62 = QVBoxLayout(self.frame_87)
        self.verticalLayout_62.setObjectName(u"verticalLayout_62")
        self.verticalLayout_62.setContentsMargins(-1, 20, -1, 20)
        self.qr1 = QLabel(self.frame_87)
        self.qr1.setObjectName(u"qr1")
        self.qr1.setPixmap(QPixmap(u"../resource/QR_img.png"))

        self.verticalLayout_62.addWidget(self.qr1, 0, Qt.AlignHCenter)
...
"}")
        ...
        font23 = QFont()
        font23.setPointSize(25)
        font23.setBold(True)
        self.sent_postcard_image.setFont(font23)
        ...
        self.verticalLayout_79.addWidget(self.frame_95, 0, Qt.AlignHCenter|Qt.AlignVCenter)
...
"border-radius: 30px;")
        ...
        self.pushButton_63.setFont(font19)
...
"border-radius: 30px;")
        ...
        self.pushButton_77.setFont(font19)
...
"border-radius: 30px;")
        ...
        self.verticalLayout_101 = QVBoxLayout(self.page_13)
        self.verticalLayout_101.setObjectName(u"verticalLayout_101")
        self.stackedPages2.addWidget(self.page_13)
        ...
        self.pushButton_9.clicked.connect(MainWindow.moveto_postcard)
        self.verticalSlider_31.valueChanged.connect(MainWindow.change_volume)
        self.pushButton_20.clicked.connect(MainWindow.check_pw_validation)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.gift_reply_playtime.setText(QCoreApplication.translate("MainWindow", u"0:00", None))
        self.gift_reply_fulltime.setText(QCoreApplication.translate("MainWindow", u"3:34", None))
        ...
        self.postcard_detail_img.setText("")
        ...
        self.pushButton_15.setText(QCoreApplication.translate("MainWindow", u"\ub85c\uadf8\uc778\ud558\uae30", None))
        self.qr2.setText("")
        ...
        self.label_54.setText(QCoreApplication.translate("MainWindow", u"\uc778\uc99d \ucf54\ub4dc\ub97c \uc785\ub825\ud574\uc8fc\uc138\uc694.(\ud2b9\uc218\ubb38\uc790\ub294 \ube7c\uace0 \uc785\ub825\ud574\uc8fc\uc138\uc694.)", None))
        self.pushButton_20.setText(QCoreApplication.translate("MainWindow", u"\uc911\ubcf5\ud655\uc778", None))
        ...
        self.pushButton_24.setText(QCoreApplication.translate("MainWindow", u"\ub85c\uadf8\uc778\ud558\uae30", None))
        self.qr1.setText("")
        ...
        self.manito_painter_data.setText(QCoreApplication.translate("MainWindow", u"Ditto - New Jeans", None))
        ...
        self.postcard_painter_data.setText(QCoreApplication.translate("MainWindow", u"Ditto - New Jeans", None))
