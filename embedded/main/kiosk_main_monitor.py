...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u"../resource/icons/play.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon3 = QIcon()
        icon3.addFile(u"../resource/icons/search_black.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.pushButton_79.setIcon(icon3)
...
"}")
        ...
        icon4 = QIcon()
        icon4.addFile(u"../resource/icons/secret.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.pushButton_99.setIcon(icon2)
...
" color:black; background-color: #2ae2e2;}")
        ...
        self.pushButton_100.setIcon(icon2)
